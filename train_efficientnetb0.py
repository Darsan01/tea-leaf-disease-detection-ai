...
RESULTS_DIR = "results_efficientnetb0"
...
checkpoint = ModelCheckpoint(
    filepath=os.path.join(RESULTS_DIR, "best_efficientnetb0_model.keras"),
...
model.save(os.path.join(RESULTS_DIR, "final_efficientnetb0_model.keras"))
...
plt.ylabel("Accuracy")
plt.legend()
plt.savefig(os.path.join(RESULTS_DIR, "efficientnetb0_accuracy.png"))
plt.close()
...
plt.ylabel("Loss")
plt.legend()
plt.savefig(os.path.join(RESULTS_DIR, "efficientnetb0_loss.png"))
plt.close()

print("Evaluating EfficientNetB0 model on test data...")
...
with open(os.path.join(RESULTS_DIR, "efficientnetb0_classification_report.txt"), "w") as file:
    file.write("EfficientNetB0 Classification Report\n")
    file.write("===================================\n\n")
...
plt.colorbar()
plt.tight_layout()
plt.savefig(os.path.join(RESULTS_DIR, "efficientnetb0_confusion_matrix.png"))
plt.close()
